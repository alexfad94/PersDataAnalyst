...
class AIService:
        ...
        *,
        ...
        prompt_payload = {
            ...
            "available_actions": [
                ...
                {
                    "type": "generate_chart",
                    "chart_type": "histogram | bar | line | pie",
    ...
    def _system_prompt(self) -> str:
        return (
            ...
            "Ты — финансовый аналитик: оцениваешь выручку, затраты, доли, динамику и риски, "
            "формулируешь выводы в терминах денег, маржи и структуры показателей. "
            ...
            "Для долей и структуры категорий предпочитай pie-график. "
        ...
        for item in payload.get("actions", []):
            ...
            if action_type == "generate_chart":
                ...
                normalized["chart_type"] = (
                    chart_type if chart_type in {"histogram", "bar", "line", "pie"} else "bar"
                )
